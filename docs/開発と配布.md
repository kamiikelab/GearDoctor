...
Play ストアを経由しません。案内するのは [Releases](https://github.com/kamiikelab/GearDoctor/releases) です。Android の Chrome で、次の順に進めてください。
...
渡すのはソースではなく APK です。案内するのは上記の「2. APK ファイルを渡して入れる」です。USB デバッグは不要です。新しい版を配るときは、APK を作って同じ Releases に添付します。
